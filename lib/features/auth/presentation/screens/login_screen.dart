      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFF4F6F3), Color(0xFFE4EEE5)],
          ),
        ),
        child: SafeArea(
          child: LayoutBuilder(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        ...
                        boxShadow: const [
                          BoxShadow(color: Color(0x1A173F28), blurRadius: 50, offset: Offset(0, 20)),
                        ],
                      ),
                      child: isWide
                          ? Row(
          ...
          children: [
            Row(
              children: [
                ...
                const Text('Hej', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, letterSpacing: -1)),
              ],
            ),
            const SizedBox(height: 40),
            Text(
              'Welcome back',
              style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w800, letterSpacing: -0.8),
            ),
            const SizedBox(height: 8),
            const Text('Sign in to open your spaces.', style: TextStyle(color: Colors.black54, fontSize: 16)),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Text('YOUR SPACE. YOUR WAY.', style: TextStyle(color: Color(0xFFD8F3DC), fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 1.1)),
          ),
          const SizedBox(height: 26),
          Text(
            'One flexible home for every group.',
            style: Theme.of(context).textTheme.displaySmall?.copyWith(color: Colors.white, fontWeight: FontWeight.w800, height: 1.08, letterSpacing: -1.5),
          ),
          ...
          const Wrap(
            ...
            runSpacing: 10,
            children: [
              _FeatureChip(icon: Icons.chat_bubble_outline_rounded, label: 'Chat'),
              _FeatureChip(icon: Icons.calendar_month_outlined, label: 'Plans'),
              _FeatureChip(icon: Icons.folder_open_rounded, label: 'Files'),
              _FeatureChip(icon: Icons.photo_library_outlined, label: 'Memories'),
            ],
          ),
        ],
      ),
